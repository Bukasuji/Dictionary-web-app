                    ...
                    <ul className='list-disc text-xl marker:text-purple-500 marker:text-xs mt-6'>
                        {meaning.definitions.map((definition, idx) => (
                            <div key={idx}>
                             ...
                             {/*{synonyms && (<p className='mb-3 ml-10 text-slate-500'>"{definition.synonyms}"</p>) }*/}
                            </div>
                        ))}
                    </ul>

                   {/* <ul className='list-disc marker:text-purple-500 marker:text-xs mt-6 ml-10 '>
                        {meaning.definitions.map((definition, idx) => (
                            <div key={idx}>
